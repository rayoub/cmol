$reportType = (Read-Host "Enter the report type (Common|Comp|Heme)").Trim()

$panel = ""
$suffix = ""
$submitDir = "\\kumc.edu\data\Research\CANCTR RSCH\CMOL\Patient Reports\"
if ($reportType -ieq "Common") {
    $panel = " NGS Common Assay Result Summary"
    $suffix = "-NGS Common Assay Result Summary.docx"
    $submitDir += "NGS Common\NGS COMMON To be Submitted"
}
elseif ($reportType -ieq "Comp") {
    $panel = "Comprehensive Cancer Targeted Gene Panel (275) by NGS"
    $suffix = "-NGS Comprehensive Assay Result Summary.docx"
    $submitDir += "NGS Comprehensive\NGS Comprehensive To be Submitted"
}
elseif ($reportType -ieq "Heme") {
    $panel = "Hematologic Neoplasms Targeted Gene Panel (141) by NGS"
    $suffix = "-NGS HEME Assay Result Summary.docx"
